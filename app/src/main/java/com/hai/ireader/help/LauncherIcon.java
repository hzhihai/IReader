...
public class LauncherIcon {
    ...
    private static ComponentName componentNameMain = new ComponentName(ReaderApplication.getInstance(), "com.hai.ireader.view.activity.WelcomeActivity");
    private static ComponentName componentNameBookMain = new ComponentName(ReaderApplication.getInstance(), "com.hai.ireader.view.activity.WelcomeBookActivity");
