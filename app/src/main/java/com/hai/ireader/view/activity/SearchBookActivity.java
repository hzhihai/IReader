...
import com.hai.ireader.presenter.BookDetailPresenter;
import com.hai.ireader.presenter.SearchBookPresenter;
import com.hai.ireader.presenter.contract.SearchBookContract;
...
import com.hai.ireader.view.adapter.SearchBookAdapter;
import com.hai.ireader.widget.explosion_field.ExplosionField;
import com.hai.ireader.widget.recycler.refresh.OnLoadMoreListener;
import com.hai.ireader.widget.recycler.refresh.RefreshRecyclerView;
...
public class SearchBookActivity extends MBaseActivity<SearchBookContract.Presenter> implements SearchBookContract.View {
    ...
    protected void bindView() {
        ...
        initSearchView();
        setSupportActionBar(toolbar,0,false);
        setupActionBar();
        fabSearchStop.hide();
