...
import com.hai.ireader.help.ChapterContentHelp;
...
import com.hai.ireader.presenter.contract.ReadBookContract;
import com.hai.ireader.service.ReadAloudService;
import com.hai.ireader.utils.BatteryUtil;
...
import com.hai.ireader.utils.SystemUtil;
import com.hai.ireader.utils.bar.BarHide;
...
import com.hai.ireader.view.popupwindow.CheckAddShelfPop;
import com.hai.ireader.view.popupwindow.MediaPlayerPop;
import com.hai.ireader.view.popupwindow.MoreSettingPop;
import com.hai.ireader.view.popupwindow.ReadAdjustPop;
import com.hai.ireader.view.popupwindow.ReadBottomMenu;
import com.hai.ireader.view.popupwindow.ReadInterfacePop;
import com.hai.ireader.view.popupwindow.ReadLongPressPop;
import com.hai.ireader.widget.modialog.BookmarkDialog;
import com.hai.ireader.widget.modialog.ChangeSourceDialog;
import com.hai.ireader.widget.modialog.DownLoadDialog;
import com.hai.ireader.widget.modialog.InputDialog;
import com.hai.ireader.widget.modialog.MoDialogHUD;
import com.hai.ireader.widget.modialog.ReplaceRuleDialog;
import com.hai.ireader.widget.page.PageLoader;
import com.hai.ireader.widget.page.PageLoaderNet;
import com.hai.ireader.widget.page.PageView;
import com.hai.ireader.widget.page.TxtChapter;
...
public class ReadBookActivity extends MBaseActivity<ReadBookContract.Presenter> implements ReadBookContract.View, View.OnTouchListener {
    ...
    private int GetColor(){
        return  getResources().getColor(R.color.reader_toolbar_bg_color);
    }

    @Override
    protected void bindView() {
        ButterKnife.bind(this);
        this.setSupportActionBar(toolbar,this.GetColor(),true);
        setupActionBar();
        mPresenter.initData(this);
        appBar.setPadding(0, ScreenUtils.getStatusBarHeight(), 0, 0);
        appBar.setBackgroundColor(this.GetColor());
