...
public class MainActivity extends BaseTabActivity<MainContract.Presenter> implements MainContract.View, BookListFragment.CallbackValue {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //初始化书源库
        BookSourceService.InitBookSource(this);
    }
    ...
    private OnNavigationItemSelectedListener mOnNavigationItemSelectedListener
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            //String itemTite = item.getTitle().toString();
            //toolbar.setTitle(itemTite);
     ...
     * @param item
     */
    private void resetItemSIcon(MenuItem item)
    {
        if (item!=null)
        {
            switch (item.getItemId()) {
                case R.id.navigation_bookshelf: {
                    item.setIcon(R.drawable.ic_arrange);
                    break;
                }
                case  R.id.navigation_find:{
